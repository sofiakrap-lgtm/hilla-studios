...
function initFeatureInfo() {
  ...
  const INFO = {
    ...
    "Lisäsivu": { t: "Yksi lisäsivu Basicin päälle, esimerkiksi UKK, tarina tai oma kampanjasivu. Sama ilme, oma kohta valikossa.", d: "https://sofiakrap-lgtm.github.io/nails-demo/faq.html" },
    "Karttaintegraatio": { t: "Upotettu kartta, joka näyttää sijaintisi suoraan sivulla. Asiakas löytää perille ilman erillistä hakua.", d: "https://sofiakrap-lgtm.github.io/nails-demo/contact.html" },
    "Ajanvarausjärjestelmä": { t: "Ajanvaraus toteutetaan liittämällä sivustoosi luotettava varausjärjestelmä, joka sopii juuri sinun alallesi. Esimerkkejä: Vello, Timma, Calendly tai Acuity. Asiakas varaa ajan itse verkossa vuorokauden ympäri, ja varaus näkyy suoraan kalenterissasi – mukana varausvahvistukset ja muistutukset.", d: "https://sofiakrap-lgtm.github.io/nails-demo/booking.html", note: ARVIO },
    "Pöytävarausjärjestelmä": { t: "Pöytävaraus toteutetaan integroimalla ravintola-alan varausjärjestelmä sivustolle. Esimerkkejä: TableOnline, ResDiary tai OpenTable. Asiakas valitsee ajankohdan ja seurueen koon, ja varaus ohjautuu suoraan teille.", d: "https://sofiakrap-lgtm.github.io/sol-calle/ota-yhteytta.html", note: ARVIO },
    "Kanta-asiakasjärjestelmä": { t: "Toteutetaan kanta-asiakas- tai jäsenyystyökalulla, joka liitetään sivustoon. Esimerkkejä: MailerLite tai Mailchimp (edut ja viestintä) tai kevyt oma leimakortti-/etujärjestelmä. Palkitset uskolliset asiakkaat eduilla ja kampanjoilla, ja saat heidät palaamaan.", d: "https://sofiakrap-lgtm.github.io/velora-movement/yhteiso.html", note: ARVIO },
    "Verkkokauppa": { t: "Verkkokauppa rakennetaan sopivalla kauppa-alustalla tuotteidesi ja arkesi ympärille. Esimerkkejä: WooCommerce, Shopify tai kevyt Stripe-/MyCashflow-pohjainen ratkaisu. Sisältää tuotteet, ostoskorin ja maksut – tarvittaessa myös toimitustavat ja varastonhallinnan.", d: "https://sofiakrap-lgtm.github.io/velora-movement/kauppa.html", note: ARVIO },
    "Blogi / uutiset": { t: "Toteutetaan helppokäyttöisellä julkaisunäkymällä, jolla lisäät juttuja, vinkkejä ja uutisia itse ilman koodia. Tuore sisältö parantaa myös löydettävyyttä Googlessa.", d: "https://sofiakrap-lgtm.github.io/MyrakTesti/ajankohtaista.html", note: ARVIO },
    ...
    "Monikielisyys (+1 kieli)": { t: "Sivusto myös toisella kielellä, esimerkiksi englanniksi. Tavoitat laajemman yleisön. Hinta on per lisättävä kieli.", d: "https://sofiakrap-lgtm.github.io/MyrakTesti/index.html" },
    ...
    "Rekry-lomakkeiden vastaanotto": { t: "Toteutetaan lomaketyökalulla, joka kerää hakemukset ja liitteet (esim. CV) ja lähettää ne koottuna sähköpostiisi. Esimerkkejä: Static Forms, Formspree tai vastaava.", d: "https://sofiakrap-lgtm.github.io/sol-calle/ota-yhteytta.html", note: ARVIO },
    "Hintalaskuri omalle sivulle": { t: "Rakennamme sivullesi vastaavan interaktiivisen hintalaskurin kuin tämä. Asiakas valitsee palvelut, saa hinta-arvion heti ja voi lähettää sen pohjalta tarjouspyynnön.", d: "https://sofiakrap-lgtm.github.io/cake-atelier-demo/hintalaskuri.html", note: ARVIO }
  };
